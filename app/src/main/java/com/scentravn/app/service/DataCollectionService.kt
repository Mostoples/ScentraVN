package com.scentravn.app.service
...
import com.scentravn.app.R
import com.scentravn.app.data.repository.ScentraVNRepository
import com.scentravn.app.ui.MainActivity
 ...
 *
 * The service does *not* own any BLE state itself; the [ScentraVNRepository]
...
class DataCollectionService : Service() {
    ...
    @Inject lateinit var repository: ScentraVNRepository
    ...
    companion object {
        const val ACTION_START = "com.scentravn.app.action.SESSION_START"
        const val ACTION_STOP = "com.scentravn.app.action.SESSION_STOP"
        private const val NOTIF_ID = 2001
        private const val CHANNEL_ID = "scentravn_collection"

package com.scentravn.app.data.export
...
class CsvExporter @Inject constructor(
     ...
     * "Saved to Downloads/scentravn/..." toast), or null on failure.
     */
    suspend fun export(sessionId: Long): String? = withContext(Dispatchers.IO) {
        ...
        val filename = "scentravn_session_${sessionId}_${session.startedAtMs}.csv"
        ...
        return@withContext "Downloads/scentravn/$filename"
    }
    ...
    private fun openOutput(filename: String): OutputStream? {
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            val values = ContentValues().apply {
                ...
                put(MediaStore.Downloads.RELATIVE_PATH, "${Environment.DIRECTORY_DOWNLOADS}/scentravn")
            }
            ...
            val dir = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "scentravn")

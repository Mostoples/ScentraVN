...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideDatabase(@ApplicationContext context: Context): BioCompareDatabase {
        return Room.databaseBuilder(
            context,
            BioCompareDatabase::class.java,
            "biocompare.db",
        )
    ...
    @Provides fun provideSessionDao(db: BioCompareDatabase): SessionDao = db.sessionDao()
    @Provides fun provideSampleDao(db: BioCompareDatabase): SampleDao = db.sampleDao()
